...
import com.ronaldo.pace.feature.store.list.StoreListUiEvent.OnItemSelected
import com.ronaldo.pace.feature.store.list.StoreListUiEvent.OnReachedBottom
import com.ronaldo.pace.feature.store.list.StoreListUiEvent.Retry
...
private fun LazyListScope.drawLoadMorePadding() {
    item("padding") {
        Box(
            Modifier
                .fillMaxWidth()
